                ...
                :    
                   ...
                   <div class="timeline-group timeline-match removeMargin" style={{backgroundImage:'url(' + stadiumImg + ')'}}>
                    ...
                    <ul class="timeline-match-team">
                        <li>
                            <span class="team-img" onClick={() => history.push(`/club-info/${hometeamid}`)}><img src={hometeamlogo} alt="Team"/></span>
                        ...
                        <li>
                            <span class="team-img" onClick={() => history.push(`/club-info/${awayteamid}`)}><img src={awayteamlogo} alt="Team"/></span>
