    ...
    return (
      ...
      <div class="cover-board" style={{ paddingTop: '24px' }}>
        {isUserExistInFirstPart ?
                ...
                return <>
                  <div class="board shadow">
                    ...
                    {/* {!!score.history && score.history.slice(startIndex, limitTo).map((details, index) => {
                     ...
                     <div style={{color:"#A8A8A8" ,fontSize:"11px",fontStyle:"italic"}}>User Subscribe from <Moment format="ddd, DD/MM/YY">{score.subscribe_date}</Moment> with &nbsp;{score.renewal_count} &nbsp;charge</div>
                  </div>
                  {/* <div class="see-all">
                    <a onClick={this.onSeeAll((score.history.length - 1))}>See All</a>
                  </div> */}
          ...
          {this.state.fullArray.length == 0 ? null  :
